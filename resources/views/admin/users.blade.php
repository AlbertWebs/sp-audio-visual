                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            @foreach($User as $value)
                                                <tr class="odd gradeX">
                                                    ...
                                                    @else
                                                    <td class="center"><a onclick="return confirm('Delete This User?')" href="{{url('/admin')}}/deleteUser/{{$value->id}}"   class="btn btn-danger"><i class="icon-trash icon-white"></i> Del</a></td>
                                                    @endif
                                                </tr>
                                            @endforeach
