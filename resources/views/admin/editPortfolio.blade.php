				...
				@endif
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="link" value="{{$Portfolio->link}}" placeholder="e.g https://www.julietwangui.com" class="form-control" />
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="venue" value="{{$Portfolio->venue}}" placeholder="Ghana" class="form-control" />
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Audience</label>

                        <div class="col-lg-8">
                            <input type="text" id="text1" name="audience" value="{{$Portfolio->audience}}" placeholder="10000" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <?php $Servicee = DB::table('services')->where('id',$Portfolio->service)->get(); ?>
