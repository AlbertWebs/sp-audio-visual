            ...
            <div class="inner" style="min-height: 700px;"> 
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <center><h2> Add Industries </h2></center>
                    </div>
                </div>
                  <hr />
                 <!--BLOCK SECTION -->
              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/add_Industries')}}" enctype="multipart/form-data">
                    
                 <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Industy Name</label>

                        <div class="col-lg-8">
                            <input type="text" id="text1" name="name" value="" placeholder="e.g Web Development " class="form-control" />
                        </div>
                    </div>
