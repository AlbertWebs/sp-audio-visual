            ...
            <div class="inner" style="min-height: 700px;"> 
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <center><h2> Edit Extra </h2></center>
                    </div>
                </div>
                  <hr />
                 <!--BLOCK SECTION -->
              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/edit_Extras')}}/{{$Extra->id}}" enctype="multipart/form-data">
                    
                 <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Extra Name</label>

                        <div class="col-lg-8">
                            <input type="text" id="text1" name="name" value="{{$Extra->title}}" placeholder="e.g Web Development " class="form-control" />
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="image_one_cheat" value="{{$Extra->image}}">
                    <input type="hidden" name="service_id" value="{{$Extra->service_id}}">
