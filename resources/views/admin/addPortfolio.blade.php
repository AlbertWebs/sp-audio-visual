				...
				@endif
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="link" value="" placeholder="e.g GHJHD7668S" class="form-control" />
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="venue" placeholder="Ghana" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="audience"  placeholder="10000" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 text-center">
                      <button type="submit" class="btn btn-success"><i class="icon-plus icon-white"></i> Add Page</button>
                    </div>
