...
<div style="text-align: center;">
                            ...
                            <a title="Company Profile" class="quick-btn" href="{{url('/admin/profile')}}">
                                <i class="icon-file icon-2x"></i>
                                <span>Profile</span>
                                <span class="label btn-metis-2"><?php $Profile = DB::table('files')->get(); $Count = count($Profile); echo $Count ?></span>
                            </a>
                            ...
                            <a class="quick-btn" href="{{url('/admin/admins')}}">
                             ...
                             <a class="quick-btn" href="{{url('/admin/clients')}}">
                                ...
                                <span>Clients</span>
                                <span class="label label-danger"><?php $Admins = DB::table('clients')->get(); $Count = count($Admins); echo $Count ?></span>
                            </a>
