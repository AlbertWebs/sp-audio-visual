        ...
        <div class="rd-navbar-inner">
          ...
          <div class="rd-navbar-group">
            <div class="rd-navbar-panel">
              ...
              <a href="{{url('/')}}" class="rd-navbar-brand brand"><img src="{{url('/')}}/uploads/logo/{{$Settings->logo}}" width="200" height="22" alt="Stagepass Audio Visual logo"/></a> </div>
            <div class="rd-navbar-nav-wrap">
              <div class="rd-navbar-nav-inner">
                <ul class="rd-navbar-nav">
                  <li class="<?php if($page_name == 'Home'){echo "active"; }else{ echo "";} ?>"><a href="{{url('/')}}">Home</a> </li>
                  <li class="<?php if($page_name == 'About'){echo "active"; }else{ echo "";} ?>"><a href="{{url('/')}}/about-us">About Us</a></li>

                  <li class="<?php if($page_name == 'Work'){echo "active"; }else{ echo "";} ?>"><a href="{{url('/')}}/our-work">Our Work</a></li>
                  ...
                  <ul class="rd-navbar-dropdown">
                      ...
                      <li><a href="{{url('/service')}}/{{$Service->slung}}"><span class="{{$Service->icon}}"></span>{{$Service->title}}</a> </li>
                      @endforeach
                  ...
                  <li class="<?php if($page_name == 'Contact'){echo "active"; }else{ echo "";} ?>"><a href="{{url('/contact-us')}}">Contact Us</a></li>
                  <li  class="pull-right"><a style="background-color:#F6C501; padding:5px 5px" class="btn btn-sm btn-primary" href="{{url('/get-an-av-quote')}}">Get An AV Quote</a></li>
                </ul>
              ...
              <div style="max-width: 340px;" class="row offset-top-22 offset-md-top-30">
                <div class="col-xs-6">
                  <ul class="list-marked-variant-2">
                    ...
                    <li><a href="{{url('/our-portfolio')}}">Our Work</a></li>
                    
                  </ul>
                </div>
                <div class="col-xs-6">
                  <ul class="list-marked-variant-2">
                  <li><a href="{{url('/get-an-av-quote')}}">Get Quote</a></li>
                  <li><a href="{{url('/our-industries')}}">Industries</a></li>
                    <?php $Blog = DB::table('blog')->get() ?>
                    @if($Blog->isEmpty())
                    @else
