...
<style>
  ...
  @include('front.breadcrumb')
    ...
    <section data-on="false" data-md-on="true" style="background-image: url('{{url('/')}}/uploads/banners/image.webp'); background-position: center center;" class="rd-parallax bg-gray-base bg-image overlay-tint">
                      ...
                      <dd class="righty">
                        <ul class="list-inline list-inline-reset">
                          ...
                          @foreach($SiteSettings as $Settings)
                            <li><a target="_new" href="{{$Settings->facebook}}" class="icon icon-round icon-gray-dark-filled icon-xxs-smallest fa fa-facebook fa-2x facebook-icon"></a></li>
      ...
      <div class="shell">
        <div class="range range-md-justify">
          ...
          <div class="cell-md-12 cell-lg-12 offset-top-50 offset-md-top-0"> 
            <h3>Get in Touch</h3>
            <form data-form-output="form-output-global" data-form-type="contact" method="post" action="{{url('/submitMessage')}}" class="rd-mailform-msg form-modern offset-top-30">
              <div class="range">
                <div class="cell-sm-6">
