   ...
   <!-- PAGE CONTENT --> 
    ...
    <div class="tab-content">
        ...
        <div id="signup" class="tab-pane">
            ...
            <form class="form-horizontal form-signin" method="POST" action="<?php echo e(route('register')); ?>">
            <?php echo e(csrf_field()); ?>

                <p class="text-muted text-center btn-block btn btn-primary btn-rect">New User Register</p>
                 
                 <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                            <input placeholder="Name" id="name" type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" required autofocus>
                  ...
                  <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                                ...
                                <input placeholder="juliekoi@gmail.com" id="email" type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>" required>
    ...
    <!-- END BODY -->
</html><?php /**PATH /home/stagepassco/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>