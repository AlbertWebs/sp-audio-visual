        ...
        <div class="range range-sm-center range-md-left">
          <div class="cell-sm-6 cell-md-6">
            <div class="thumbnail thumbnail-profile">
              <div class="thumbnail-image"><img src="<?php echo e(url('/')); ?>/uploads/industries/<?php echo e($industries->image); ?>" alt="" width="570" height="570"/> </div>
                  ...
                  <ul>
                    <li>
                      <div class="unit unit-horizontal unit-spacing-xs unit-middle">
                        ...
                        <div class="unit-body"><h5><?php echo e($industries->title); ?></h5></div>
                      </div>
                    </li>
                    
                  </ul>
                  <div class="btn-wrap"><a href="<?php echo e(url('/quote')); ?>" class="btn btn-small btn-gray-base-outline">Request Quote</a></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="offset-top-15 offset-md-top-0">
              <blockquote class="quote-default">
                ...
                <div class="quote-body">
                  <p> <q><?php echo html_entity_decode($industries->content); ?></q> </p>
                </div>
...
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/stagepassco/public_html/resources/views/front/industry.blade.php ENDPATH**/ ?>