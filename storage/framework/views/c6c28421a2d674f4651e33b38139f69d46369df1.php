...
<?php else: ?>
<link rel="stylesheet" href="<?php echo e(asset('theme/css/stylee.css')); ?>">
<?php endif; ?>
  ...
  <div class="page-inner">
    <header class="page-head">
      ...
      <div class="page-head-inner">
        <div class="shell text-center"><a href="#" class="brand brand-md"><img src="<?php echo e(url('/')); ?>/uploads/logo/stagepassAVLogo.png" width="200" height="22" alt="logo"/></a> </div>
      </div>
    </header>
      ...
      <div class="shell">
        <div class="range range-sm-center">
          ...
          <div class="cell-sm-6 cell-md-5 cell-lg-4 offset-top-40 offset-sm-top-60 offset-xl-top-120">
            ...
            <form data-form-output="form-output-global" data-form-type="subscribe" method="post" action="<?php echo e(url('/subscribe')); ?>" class="rd-mailform form-modern form-inverse offset-top-40">
      ...
      <div class="page-foot-inner">
        <div class="shell text-center">
          <div class="range">
            ...
            <p class="rights text-white-03"><span>&#169;&nbsp;</span><span id="copyright-year"></span><span><a href="<?php echo e(url('/copyright')); ?>" class="link-white-03">StagePass Audio Visual</a></span> |  Powered by <a href="https://designekta.com" class="link-white-03"> Designekta Studios</a> </p>
            </div>
          </div>
        </div>
      </div>
...
<?php /**PATH /home/stagepassco/public_html/resources/views/front/commingsoon.blade.php ENDPATH**/ ?>