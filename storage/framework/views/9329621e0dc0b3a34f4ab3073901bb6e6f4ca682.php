      ...
      <div class="shell">
        <div class="range">
          <div class="cell-md-9 cell-lg-12">
            ...
            <form data-form-output="form-output-global" data-form-type="contact" method="post" action="<?php echo e(url('/quote_request')); ?>" class="offset-top-40" enctype="multipart/form-data">
              <div class="range">
                <div class="cell-sm-6">
...
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/stagepassco/public_html/resources/views/front/quote.blade.php ENDPATH**/ ?>