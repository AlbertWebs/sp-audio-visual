      ...
      <div class="shell">
        <div class="range">
          <div class="cell-md-9 cell-lg-12">
            <h3>Submit RFP</h3>
            <form data-form-output="form-output-global" data-form-type="contact" method="post" action="<?php echo e(url('/post_rfp')); ?>" class="offset-top-40" enctype="multipart/form-data">
              <div class="range">
                <div class="cell-sm-6">
...
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/stagepassco/public_html/resources/views/front/rfp.blade.php ENDPATH**/ ?>