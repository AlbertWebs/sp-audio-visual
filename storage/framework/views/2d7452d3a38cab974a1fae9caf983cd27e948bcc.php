        ...
        <div class="range range-md-bottom range-sm-center">
          ...
          <div class="cell-sm-11 cell-md-7 offset-top-40 offset-sm-top-60 offset-md-top-0">
            <div class="image-group">
              <figure data-wow-duration=".6s" data-wow-delay=".0s" data-wow-offset="80" class="wow fadeInRightSmall"><img src="<?php echo e(url('/')); ?>/uploads/images/<?php echo e($about->image); ?>" alt="Stagepass Audio Visual Limited" width="243" height="199"/> </figure>
              <figure data-wow-duration=".9s" data-wow-delay=".4s" data-wow-offset="200" class="wow fadeInRightMedium"><img src="<?php echo e(url('/')); ?>/uploads/images/<?php echo e($about->image_one); ?>" alt="Stagepass Audio Visual Limited" width="508" height="341"/> </figure>
              <figure data-wow-duration=".9s" data-wow-delay=".8s" data-wow-offset="300" class="wow fadeInRightSmall"><img src="<?php echo e(url('/')); ?>/uploads/images/<?php echo e($about->image_two); ?>" alt="Stagepass Audio Visual Limited" width="689" height="469"/> </figure>
            </div>
          </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="shell">
            ...
            <?php $__currentLoopData = $Services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
              <div class="cell-sm-6 cell-md-4 offset-top-50 offset-sm-top-0">
                <article class="icon-box-vertical"><span class="icon icon-primary icon-md"><img alt="<?php echo e($service->title); ?>" src="<?php echo e(url('/')); ?>/uploads/<?php echo e($service->icon); ?>"></span>
    ...
    <section class="ours">
        ...
        <div class="ours-right">
          <div class="ours-right-one">
            <img src="<?php echo e(asset('theme/images/image-018.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
          <div class="ours-right-two">
            <img src="<?php echo e(asset('theme/images/image-015.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
          <div class="ours-right-three">
            <img src="<?php echo e(asset('theme/images/image-020.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
          <div class="ours-right-four">
            <img src="<?php echo e(asset('theme/images/image-016.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
          <div class="ours-right-five">
            <img src="<?php echo e(asset('theme/images/image-013.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
          <div class="ours-right-six">
            <img src="<?php echo e(asset('theme/images/image-010.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
          <div class="ours-right-seven">
            <img src="<?php echo e(asset('theme/images/image-008.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
          <div class="ours-right-eight">
            <img src="<?php echo e(asset('theme/images/image-006.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
          <div class="ours-right-nine">
            <img src="<?php echo e(asset('theme/images/image-005.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
          <div class="ours-right-ten">
            <img src="<?php echo e(asset('theme/images/image-004.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
          <div class="ours-right-eleven">
            <img src="<?php echo e(asset('theme/images/image-000.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
          <div class="ours-right-twelve">
            <img src="<?php echo e(asset('theme/images/image-002.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
          <div class="ours-right-thirteen">
            <img src="<?php echo e(asset('theme/images/image-026.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
          <div class="ours-right-fourteen">
            <img src="<?php echo e(asset('theme/images/image-024.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
          <div class="ours-right-fifteen">
            <img src="<?php echo e(asset('theme/images/image-022.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
          <div class="ours-right-sixteen">
            <img src="<?php echo e(asset('theme/images/image-028.png')); ?>" alt="Stagepass Audio Visual Limited" />
          </div>
        </div>
      </section>
...
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/designekta/sp-audio-visual/resources/views/front/index1.blade.php ENDPATH**/ ?>