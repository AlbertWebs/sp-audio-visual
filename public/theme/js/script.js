...
$(document).ready(function() {
    ...
    plugins = {
        ...
        rdMailFormQuote: $(".rd-mailform-quote"),
        rdMailFormMessage: $(".rd-mailform-msg"),
        rdMailFormComment: $(".rd-mailform-comment"),
                ...
                success: function(result) {
                    if (!isNoviBuilder) {
                        ...
                        if (result === "MF000") {
                            ...
                            if (output.hasClass("snackbars")) {
                                output.html(' <p class="snackbars-left"><span class="icon icon-xs fa-check text-middle"></span><span>' + msg[result] + '</span></p>');
                            } else {
    ...
    if (plugins.rdMailFormQuote.length) {
        var i, j, k, msg = {
            'MF000': 'Successfully sent!',
            'MF001': 'Recipients are not set!',
            'MF002': 'Form will not work locally!',
            ...
            'MF004': 'Please, define type of your form!',
            'MF254': 'Something went wrong with PHPMailer!',
            'MF255': 'Your Request has Been Received.'
        };
        for (i = 0; i < plugins.rdMailFormQuote.length; i++) {
            var $form = $(plugins.rdMailFormQuote[i]);
            $form.attr('novalidate', 'novalidate').ajaxForm({
                data: {
                    "form-type": $form.attr("data-form-type") || "contact",
                    "counter": i
                ...
                beforeSubmit: function() {
                    if (!isNoviBuilder) {
                        var form = $(plugins.rdMailFormQuote[this.extraData.counter]);
                        var inputs = form.find("[data-constraints]");
                        if (isValidated(inputs)) {
                            var output = $("#" + form.attr("data-form-output"));
                            if (output.hasClass("snackbars")) {
                ...
                error: function(result) {
                    if (!isNoviBuilder) {
                        var output = $("#" + $(plugins.rdMailFormQuote[this.extraData.counter]).attr("data-form-output"));
                        output.text(msg[result]);
                    }
                },
                success: function(result) {
    ...
    if (plugins.rdMailFormMessage.length) {
        var i, j, k, msg = {
            'MF000': 'Successfully sent!',
            'MF001': 'Recipients are not set!',
            'MF002': 'Form will not work locally!',
            ...
            'MF004': 'Please, define type of your form!',
            'MF254': 'Something went wrong with PHPMailer!',
            'MF255': 'Message Successfully sent!.'
        };
        for (i = 0; i < plugins.rdMailFormMessage.length; i++) {
            var $form = $(plugins.rdMailFormMessage[i]);
            $form.attr('novalidate', 'novalidate').ajaxForm({
                data: {
                    "form-type": $form.attr("data-form-type") || "contact",
                    "counter": i
                ...
                beforeSubmit: function() {
                    if (!isNoviBuilder) {
                        var form = $(plugins.rdMailFormMessage[this.extraData.counter]);
                        var inputs = form.find("[data-constraints]");
                        if (isValidated(inputs)) {
                            var output = $("#" + form.attr("data-form-output"));
                            if (output.hasClass("snackbars")) {
                ...
                error: function(result) {
                    if (!isNoviBuilder) {
                        var output = $("#" + $(plugins.rdMailFormMessage[this.extraData.counter]).attr("data-form-output"));
                        output.text(msg[result]);
                    }
                },
                success: function(result) {
    ...
    if (plugins.rdMailFormComment.length) {
        var i, j, k, msg = {
            'MF000': 'Successfully sent!',
            'MF001': 'Recipients are not set!',
            'MF002': 'Form will not work locally!',
            ...
            'MF004': 'Please, define type of your form!',
            'MF254': 'Something went wrong with PHPMailer!',
            'MF255': 'Comment Successfully Posted!.'
        };
        for (i = 0; i < plugins.rdMailFormComment.length; i++) {
            var $form = $(plugins.rdMailFormComment[i]);
            $form.attr('novalidate', 'novalidate').ajaxForm({
                data: {
                    "form-type": $form.attr("data-form-type") || "contact",
                    "counter": i
                ...
                beforeSubmit: function() {
                    if (!isNoviBuilder) {
                        var form = $(plugins.rdMailFormComment[this.extraData.counter]);
                        var inputs = form.find("[data-constraints]");
                        if (isValidated(inputs)) {
                            var output = $("#" + form.attr("data-form-output"));
                            if (output.hasClass("snackbars")) {
                ...
                error: function(result) {
                    if (!isNoviBuilder) {
                        var output = $("#" + $(plugins.rdMailFormComment[this.extraData.counter]).attr("data-form-output"));
                        output.text(msg[result]);
                    }
                },
                success: function(result) {
    ...
    $( "#click-me" ).click(function() {
      ...
      $( ".x" ).click(function() {
        $( ".container-popup" ).toggle( "slow", function() {
          // Animation complete.  
        });
      });
